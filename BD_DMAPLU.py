...
st.title("📚 Biblioteca Digital DMAPLU")

st.markdown("""
Bem-vindo ao sistema de gerenciamento bibliográfico sobre
**Drenagem e Manejo de Águas Pluviais Urbanas (DMAPLU)**.
...
st.caption(
    "Biblioteca Digital DMAPLU • Versão 0.1"
)